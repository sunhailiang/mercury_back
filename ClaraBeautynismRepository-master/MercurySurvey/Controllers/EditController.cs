...
namespace MercurySurvey.Controllers
{
    ...
    public class EditController : ControllerBase
    {
        ...
        /// </summary>
        /// <returns></returns>
        public IActionResult LookQuestionnaire()
        {
        ...
        /// <returns></returns>
        public IActionResult UpdateQuestionnaire(Questionnaire questionnaire)
        {
            var result = (from s in noteContext.Questionnaire
        ...
        /// <returns></returns>
        public IActionResult DeleteQuestionnaire(Guid guid)
        {
            var result = (from s in noteContext.Questionnaire
